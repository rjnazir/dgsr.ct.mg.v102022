...
class ServiceMetierCtImprimeTechUse
{
    ...
    public function saveCtImprimeTechUse($_imprime_tech_use, $_action, $_id)
    {
        ...
        $_motif_used = $_imprime_tech_use->getItuMotifUsed();
        $_id = $_imprime_tech_use->getCtControle();
        ...
        if($_action == "reset"){
            ...
            if($this->isUsed($_imprime_tech_use->getId()) == FALSE){
            ...
            $_imprime_tech_use->setItuMotifUsed($_motif_used);
        }
    ...
    public function getSumITUsedInMonthWithMotif($_centre, $_type_it, $_mois, $_admn)
    {
        ...
        /* Récupération nombre IT utilisés pour les authenticités */
        // if($_admn == 'Particulier'){
        //     $_dql_au = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Authenticité'";
        //     $_query = $this->_entity_manager->createQuery($_dql_au);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_au = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_au = 0;
        // }
        /* Récupération nombre IT utilisés pour les autres */
        // if($_admn == 'Particulier'){
        //     $_dql_ot = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Autres'";
        //     $_query = $this->_entity_manager->createQuery($_dql_ot);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_ot = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_ot = 0;
        // }
        /* Récupération nombre IT utilisés pour les Caractéristiques */
        // if($_admn == 'Particulier'){
        //     $_dql_ca = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Caractéristique'";
        //     $_query = $this->_entity_manager->createQuery($_dql_ca);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_ca = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_ca = 0;
        // }
        /* Récupération nombre IT utilisés pour les Duplicatas */
        // if($_admn == 'Particulier'){
        //     $_dql_du = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Duplicata'";
        //     $_query = $this->_entity_manager->createQuery($_dql_du);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_du = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_du = 0;
        // }
        /* Récupération nombre IT utilisés pour les Duplicata visite */
        // if($_admn == 'Particulier'){
        //     $_dql_dv = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Duplicata visite'";
        //     $_query = $this->_entity_manager->createQuery($_dql_dv);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_dv = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_dv = 0;
        // }
        /* Récupération nombre IT utilisés pour les Duplicata réception */
        // if($_admn == 'Particulier'){
        //     $_dql_dr = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Duplicata réception'";
        //     $_query = $this->_entity_manager->createQuery($_dql_dr);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_dr = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_dr = 0;
        // }
        /* Récupération nombre IT utilisés pour les Mutations */
        // if($_admn == 'Particulier'){
        //     $_dql_mu = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Mutation'";
        //     $_query = $this->_entity_manager->createQuery($_dql_mu);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_mu = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_mu = 0;
        // }
        /* Récupération nombre IT utilisés pour les Spéciales */
        // if($_admn == 'Particulier'){
        //     $_dql_sp = "SELECT COUNT(u.id) FROM $_em_itu u WHERE u.ctCentre IN(SELECT c.id FROM $_em_ctr c WHERE c.ctrCode = (SELECT cc.ctrCode FROM $_em_ctr cc WHERE cc.id = :ct_centre_id))
        //             AND u.ituUsed = :utilise AND u.ctImprimeTech = :type_it AND u.createdAt LIKE :mois AND u.ituMotifUsed = 'Spéciale'";
        //     $_query = $this->_entity_manager->createQuery($_dql_sp);
        //     $_query->setParameter('ct_centre_id', $_centre);
        //     $_query->setParameter('utilise', 1);
        //     $_query->setParameter('type_it', $_type_it);
        //     $_query->setParameter('mois', $_mois.'%');
        //     $_nombre_sp = $_query->getSingleScalarResult();
        // }else{
        //     $_nombre_sp = 0;
        // }
        /* Récupération nombre IT utilisés pour les Spéciales */
