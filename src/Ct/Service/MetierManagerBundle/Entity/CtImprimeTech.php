...
class CtImprimeTech
{
     ...
     * @var string
     *
     * @ORM\Column(name="abrev_imprime_tech", type="string", length=12, nullable=false, unique=true)
     */
    ...
    /**
     * Set abrevImprimeTech
     *
     * @param string $abrevImprimeTech
     *
     * @return CtImprimeTech
     */
    public function setAbrevImprimeTech($abrevImprimeTech)
    {
    ...
    /**
     * Get abrevImprimeTech
     *
     * @return string
     */
    public function getAbrevImprimeTech()
    {
