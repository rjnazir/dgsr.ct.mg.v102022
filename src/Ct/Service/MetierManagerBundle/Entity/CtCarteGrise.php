 ...
 *  indexes={
 *      @ORM\Index(
 *          name="fk_ct_carte_grise_ct_carosserie1_idx",
 *          columns={"ct_carosserie_id"}),
 *      @ORM\Index(
 *          name="fk_ct_carte_grise_ct_source_energie1_idx",
 *          columns={"ct_source_energie_id"}),
 *      @ORM\Index(
 *          name="fk_ct_carte_grise_ct_vehicule1_idx",
 *          columns={"ct_vehicule_id"}),
 *      @ORM\Index(
 *          name="fk_ct_carte_grise_ct_centre1_idx",
...
class CtCarteGrise
{
     ...
     * @var CtZoneDeserte
     *
     * @ORM\ManyToOne(targetEntity="CtZoneDeserte", cascade={"persist"})
     * @ORM\JoinColumns({
