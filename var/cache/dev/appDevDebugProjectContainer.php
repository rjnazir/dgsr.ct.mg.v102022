...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c' => 'get1E54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19cService',
            '2_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c' => 'get2E54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19cService',
        ...
        $this->privates = array(
            '1_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c' => true,
            '2_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c']) ? $this->services['1_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c'] : $this->get1E54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19cService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c']) ? $this->services['2_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c'] : $this->get2E54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19cService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_72d3b56aaf376cc1403fc1ec8cc8bcb3762ba7f67c4dea74c9704019b8862ce8');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $ga = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/user/new$');

        $ha = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/user/*/edit$');

        $ia = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/verificateur/new$');

        $ja = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/verificateur/*/edit$');

        $ka = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/constatation-avant-dedouanement*');

        $la = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/constatation-avant-dedouanement-carac*');

        $ma = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/reception*');

        $na = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/visite*');

        $oa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/contre-visite*');

        $pa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/carte-grise*');

        $qa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/statistique-visite*');

        $ra = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/statistique-reception*');

        $sa = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/vehicule*');

        $ta = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $ua = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/imprime-tech*');

        $va = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/bordereau*');

        $wa = new \Symfony\Component\Security\Http\AccessMap();
        $wa->add($j, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $wa->add($k, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $wa->add($l, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $wa->add($m, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($n, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($o, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($p, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($q, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($r, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($s, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($t, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($u, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($v, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($w, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($x, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($y, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($z, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($aa, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($ba, array(0 => 'ROLE_SUPERADMIN', 1 => 'ROLE_STAFF', 2 => 'ROLE_VISITE'), NULL);
        $wa->add($ca, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($da, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($ea, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($fa, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($ga, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($ha, array(0 => 'ROLE_SUPERADMIN', 1 => 'ROLE_ADMIN'), NULL);
        $wa->add($ia, array(0 => 'ROLE_SUPERADMIN'), NULL);
        $wa->add($ja, array(0 => 'ROLE_SUPERADMIN', 1 => 'ROLE_ADMIN'), NULL);
        $wa->add($ka, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_RECEPTION'), NULL);
        $wa->add($la, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_RECEPTION'), NULL);
        $wa->add($ma, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_RECEPTION'), NULL);
        $wa->add($na, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_VISITE'), NULL);
        $wa->add($oa, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_VISITE'), NULL);
        $wa->add($pa, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_VISITE', 2 => 'ROLE_STAFF'), NULL);
        $wa->add($qa, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_VISITE', 2 => 'ROLE_STAFF'), NULL);
        $wa->add($ra, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_RECEPTION', 2 => 'ROLE_STAFF'), NULL);
        $wa->add($sa, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_VISITE', 2 => 'ROLE_STAFF'), NULL);
        $wa->add($ta, array(0 => 'ROLE_USER'), NULL);
        $wa->add($ua, array(0 => 'ROLE_SUPERADMIN', 1 => 'ROLE_APPRO'), NULL);
        $wa->add($va, array(0 => 'ROLE_SUPERADMIN', 1 => 'ROLE_APPRO'), NULL);

        $xa = new \Symfony\Component\Security\Http\HttpUtils($e, $e);

        $ya = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $xa, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($xa, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $ya->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $ya->addHandler($f);

        $za = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($xa, array());
        $za->setOptions(array('login_path' => '/', 'always_use_default_target_path' => false, 'default_target_path' => '/admin/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $za->setProviderKey('main');

        $ab = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $xa, array(), $a);
        $ab->setOptions(array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $bb = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, $i, $xa, 'main', $za, $ab, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, ${($_ = isset($this->services['security.csrf.token_manager']) ? $this->services['security.csrf.token_manager'] : $this->get('security.csrf.token_manager')) && false ?: '_'});
        $bb->setRememberMeServices($f);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($wa, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['fos_user.user_provider.username_email']) ? $this->services['fos_user.user_provider.username_email'] : $this->getFosUser_UserProvider_UsernameEmailService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $ya, 3 => $bb, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $f, $h, $a, $c, true, $i), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '632c00e18e0bb1.90586810', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $wa, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $xa, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $xa, '/', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', 'security.request_matcher.a64d671f18e5575531d76c1d1154fdc4476cb8a79c02ed7a3469178c6d7b96b5ed4e60db', true, false, 'security.user.provider.concrete.fos_userbundle', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'remember_me', 3 => 'anonymous')));
    }
    ...
    /**
     * Gets the private '1_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get1E54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19cService()
    {
        return $this->services['1_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get2E54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19cService()
    {
        return $this->services['2_e54cb7aba19e0c4addbadde6b2f929a1b38b2b08ceff23416388fb1c502ff19c'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Qc0OoFLQSG', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GS-b6Z+5a2', 0, 'yorW+2LCxrDTJ2kjorfl65', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('scpG5he7Qg', 0, 'yorW+2LCxrDTJ2kjorfl65', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i6NRkyoC1i', 0, 'yorW+2LCxrDTJ2kjorfl65', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('632c00e18e0bb1.90586810');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'dgsrmysql2022',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'libreoffice_linux_path' => '/usr/bin/libreoffice --headless -env:UserInstallation=file:///tmp --convert-to pdf',
            'libreoffice_mac_path' => '/Applications/LibreOffice.app/Contents/MacOS/soffice  --headless --convert-to pdf',
            'libreoffice_win_path' => '"C:\\Program Files\\LibreOffice\\program\\soffice.exe" --headless --convert-to pdf',
            'lo_path' => '"C:\\Program Files\\LibreOffice\\program\\soffice.exe" --headless --convert-to pdf',
            'locale' => 'fr',
            'taxe' => 0.2,
            'url_google_viewer' => 'https://docs.google.com/viewerng/viewer?',
            'libreoffice_path' => '"C:\\Program Files\\LibreOffice\\program\\soffice.exe" --headless --convert-to pdf',
