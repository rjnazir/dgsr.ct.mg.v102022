        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            elseif (0 === strpos($pathinfo, '/admin/imprime-tech')) {
                ...
                if (0 === strpos($pathinfo, '/admin/imprime-tech-use')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/imprime-tech-use/s')) {
                        ...
                        // imprimes_tech_use_statistic
                        if ('/admin/imprime-tech-use/stat' === $pathinfo) {
                            if ('GET' !== $canonicalMethod) {
                                $allow[] = 'GET';
                                goto not_imprimes_tech_use_statistic;
                            }

                            return array (  '_controller' => 'Ct\\BackOffice\\AdminBundle\\Controller\\CtImprimeTechUseController::statisticITUseAction',  '_route' => 'imprimes_tech_use_statistic',);
                        }
                        not_imprimes_tech_use_statistic:

                    }

                    elseif (0 === strpos($pathinfo, '/admin/imprime-tech-use/generer-')) {
                        ...
                        // imprimes_tech_new_stock_generate_ajax
                        if ('/admin/imprime-tech-use/generer-new-feuille-stock-it-ajax' === $pathinfo) {
                            if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                                $allow = array_merge($allow, array('GET', 'POST'));
                                goto not_imprimes_tech_new_stock_generate_ajax;
                            }

                            return array (  '_controller' => 'Ct\\BackOffice\\AdminBundle\\Controller\\CtImprimeTechUseController::generateNewFeuilleStockITAction',  '_route' => 'imprimes_tech_new_stock_generate_ajax',);
                        }
                        not_imprimes_tech_new_stock_generate_ajax:

                        // generate_new_feuille_de_caisse
                        if ('/admin/imprime-tech-use/generer-new-feuille-de-caisse' === $pathinfo) {
                            if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                                $allow = array_merge($allow, array('GET', 'POST'));
                                goto not_generate_new_feuille_de_caisse;
                            }

                            return array (  '_controller' => 'Ct\\BackOffice\\AdminBundle\\Controller\\CtImprimeTechUseController::generateNewFeuilleCaisseAction',  '_route' => 'generate_new_feuille_de_caisse',);
                        }
                        not_generate_new_feuille_de_caisse:

                    }

                    // imprimes_tech_use_statistic_generate_reporting
                    if ('/admin/imprime-tech-use/generate-reporting-use-imprimes-tech' === $pathinfo) {
                        if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                            $allow = array_merge($allow, array('GET', 'POST'));
                            goto not_imprimes_tech_use_statistic_generate_reporting;
                        }

                        return array (  '_controller' => 'Ct\\BackOffice\\AdminBundle\\Controller\\CtImprimeTechUseController::generateReportingStatisticITUseAction',  '_route' => 'imprimes_tech_use_statistic_generate_reporting',);
                    }
                    not_imprimes_tech_use_statistic_generate_reporting:

                    // imprimes_tech_test_ct_controle_ajax
                    if ('/admin/imprime-tech-use/controle-is-your-controle-ajax' === $pathinfo) {
                        if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                            $allow = array_merge($allow, array('GET', 'POST'));
                            goto not_imprimes_tech_test_ct_controle_ajax;
                        }

                        return array (  '_controller' => 'Ct\\BackOffice\\AdminBundle\\Controller\\CtImprimeTechUseController::getAllControleNoInImprimeTechUseAction',  '_route' => 'imprimes_tech_test_ct_controle_ajax',);
                    }
                    not_imprimes_tech_test_ct_controle_ajax:
