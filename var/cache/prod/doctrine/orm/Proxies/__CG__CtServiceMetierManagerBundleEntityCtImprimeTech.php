...
class CtImprimeTech extends \Ct\Service\MetierManagerBundle\Entity\CtImprimeTech implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'id', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'nomImprimeTech', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'abrevImprimeTech', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'uteImprimeTech', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'prttCreatedAt', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'prttUpdatedAt', '' . "\0" . 'Ct\\Service\\MetierManagerBundle\\Entity\\CtImprimeTech' . "\0" . 'ctUser'];
        }
    ...
    public function setAbrevImprimeTech($abrevImprimeTech)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAbrevImprimeTech', [$abrevImprimeTech]);

        return parent::setAbrevImprimeTech($abrevImprimeTech);
    }
    ...
    public function getAbrevImprimeTech()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAbrevImprimeTech', []);

        return parent::getAbrevImprimeTech();
    }
